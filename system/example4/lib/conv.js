...
$(function () {
	$("#yolo_table tr td").click(function () {
		...
		if ($.trim($(this).index()) == 4) {
			if (title_name === "Convolutional") {
				...
				var t = document.createTextNode("Layer " + title_value + " feature map result");
				...
				var title_h3 = document.createElement("h3");
				title_h3.className = "center";
                var t = document.createTextNode("Layer " + title_value + " maxpool result");
				...
				var title_h3 = document.createElement("h3");
				title_h3.className = "center";
                var t = document.createTextNode("Layer " + title_value + "reorg result");
			...
			var title_h3 = document.createElement("h3");
            title_h3.className = "center";
			var t = document.createTextNode("Layer " + title_value + "weights map result");
			title_h3.appendChild(t);
			document.getElementById('placehere').append(title_h3);
			for (i = 0; i < pic_times; i++) {
				var elem = document.createElement("img");
    ...
    $("#rect1").click(function(){
        ...
        var title_h3 = document.createElement("h3");
        title_h3.className = "center";
        var t = document.createTextNode("Layer 1 maxpool result");
        title_h3.appendChild(t);
        document.getElementById('placehere').append(title_h3);
        for (var j = 0; j < pic_times; j++) {
            var elem = document.createElement("img");
    ...
    $("#rect25").click(function(){
        ...
        var title_h3 = document.createElement("h3");
        title_h3.className = "center";
        var t = document.createTextNode("Layer 29 feature map result");
        title_h3.appendChild(t);
        document.getElementById('placehere').append(title_h3);
        for (var j = 0; j < pic_times; j++) {
            var elem = document.createElement("img");
    ...
    $("#rect26").click(function(){
        ...
        var title_h3 = document.createElement("h3");
        title_h3.className = "center";
        var t = document.createTextNode("Layer 26 feature map result");
        title_h3.appendChild(t);
        document.getElementById('placehere').append(title_h3);
        for (var j = 0; j < pic_times; j++) {
            var elem = document.createElement("img");
    ...
    $("#rect30").click(function(){
        ...
        var title_h3 = document.createElement("h3");
        title_h3.className = "center";
        var t = document.createTextNode("Layer 30 feature map result");
        title_h3.appendChild(t);
        document.getElementById('placehere').append(title_h3);
        for (var j = 0; j < pic_times; j++) {
            var elem = document.createElement("img");
    ...
    $("#rectreorg").click(function(){
        ...
        var title_h3 = document.createElement("h3");
        title_h3.className = "center";
        var t = document.createTextNode("reorganization result");
        title_h3.appendChild(t);
        document.getElementById('placehere').append(title_h3);
        for (var j = 0; j < pic_times; j++) {
            var elem = document.createElement("img");
